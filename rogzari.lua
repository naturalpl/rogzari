...
local Window = Library.CreateLib("by rogzari", "DarkTheme")
    -- MAIN
    ...
    MainSection:NewButton("CmdX", "better than inf yield.", function()
        loadstring(game:HttpGet(('https://raw.githubusercontent.com/lxte/cmd/main/testing-main.lua'),true))()
    end)


    MainSection:NewButton("Btools", "Building Tools", function()
--[[
...
grabTool.Parent = backpack
    ...
    MainSection:NewButton("Dex Explorer", "dexexp", function()
        CreateGui = function()
...
--moony
    ...
    MainSection:NewButton("Sword fight bot", "automatic sword fighting.", function()
...
humanoid:SetStateEnabled(stateType.Ragdoll, false)
    ...
    MainSection:NewButton("fpsboostr", "fps booster.", function()
_G.Settings = {
    Players = {
...
MainSection:NewButton("Turn On", "Turn On the aimbot", function()
    _G.HeadSize = 10
_G.Disabled = true
game:GetService('RunService').RenderStepped:connect(function()
if _G.Disabled then
...
v.Character.Head.Massless = true
    ...
    MainSection:NewButton("Turn Off", "Turn Off the aimbot", function()
    _G.HeadSize = 1
_G.Disabled = true
game:GetService('RunService').RenderStepped:connect(function()
if _G.Disabled then
